...
- **[Development Guide](docs/development/DEVELOPMENT.md)** - Workflow, Docker, and deployment
...
* See [DEVELOPMENT.md Section 2](docs/development/DEVELOPMENT.md#2-git-workflow-strict) for details
